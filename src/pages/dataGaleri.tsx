...
import { IGaleri } from "../types/types";
import { toast } from 'react-toastify';

const DataGaleri: React.FC = () => {
    const [newsData, setNewsData] = useState<IGaleri[]>([]);
    ...
    const handleOpenEditModal = (data: IGaleri) => {
        setEditData(data);
        setOpenModal(true);
    };
    ...
    const handleSubmit = async () => {
        ...
        if (file) {
            formData.append("fotoGaleri", file);
        }
    ...
    const handleDelete = async () => {
        ...
        try {
            await API.delete(`galeri/${selectedId}`);
                ...
                <Fade in={openModal}>
                    ...
                    >
                        <Typography variant="h6" component="h2" mb={2}>
                            {editData.id ? "Edit Galeri" : "Post Galeri"}
                        </Typography>
                        <TextField
                            label="Judul Galeri Sekolah"
                            variant="outlined"
                            size="small"
                            fullWidth
                            margin="normal"
